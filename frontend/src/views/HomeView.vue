  ...
  />
    <div class="container text-center mt-5 animate__animated animate__swing animate__backInDown">
      <div class="text ">
        ...
        <span id="landingP" class="landingP rotate-3d bold " data-char="#"> GADGET</span>
        <span id="landingP" class="landingP rotate-3d bold animate__animated " data-char="#">GALAXY. </span>
